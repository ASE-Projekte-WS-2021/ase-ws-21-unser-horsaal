...
public class EditProfileInstitutionFragment extends Fragment {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    return inflater.inflate(R.layout.fragment_edit_profile_institution, container, false);
  }

  @Override
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    super.onViewCreated(view, savedInstanceState);
    this.toolbar = view.findViewById(R.id.editProfileInstitutionFragmentToolbar);
